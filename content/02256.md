...
- options object, optional:
  - `chainId` - type `uint`, chain id respecting [EIP-155](https://eips.fyi/155); optional
...
- array with asset records:
  ...
  - `type` - type `string`, asset interface ERC identifier; e.g. `ERC20`; optional - [EIP-1820](https://eips.fyi/1820) could be used
