...
![Facebook Permissions](./assets/facebook_permissions.png)

![Log in With Apple](./assets/log_in_with_apple.jpeg)
...
![Sample prompt screenshot](./assets/permissions.png)
...
If a `wallet_requestPermissions` request is rejected, it should throw an error with a `code` value equal to `4001` as per [EIP-1193](https://eips.fyi/1193).
