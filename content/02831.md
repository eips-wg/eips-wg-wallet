...
An extension to the JavaScript Ethereum Provider API ([EIP-1193](https://eips.fyi/1193)) this creates a new message type in the event a transaction replacement occurs.
